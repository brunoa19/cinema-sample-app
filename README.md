# Cinema - Example of Microservices in Python
...
The Cinema backend is powered by 4 microservices, all of which happen to be written in Python using 
Flask. 
...
This service returns information about the users of Cinema and also provides movie suggestions to the 
